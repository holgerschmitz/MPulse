...
static const int ghostCells = 1;

typedef Array<int, 1> IndexType;

extern Array<int, 1> globalMax;
extern MPICartSubdivision<Field<double, 1> > *subdivision;
extern Array<double, 1> dx;
